...
<dict>
    ...
    <string>space.neurogate.overlay</string>
...
#!/usr/bin/env bash
exec bash "$(printf '%s' "$ROOT")/scripts/run-overlay.sh"
LAUNCH
...
echo "Open ~/Applications in Finder or search 'NeuroGate API' in Spotlight to launch."
